...
align.seqs(fasta=merged.unique.rc.fasta, reference=silva.v4.fasta)


summary.seqs(fasta=merged.unique.rc.align, count=merged.count_table)
screen.seqs(fasta=merged.unique.rc.align, count=merged.count_table, summary=merged.unique.rc.summary, start=1, end=13424, maxhomop=8)
summary.seqs(fasta=current, count=current)
filter.seqs(fasta=merged.unique.rc.good.align, vertical=T, trump=.)
...
classify.seqs(fasta=merged.unique.rc.good.filter.unique.precluster.pick.fasta, count=merged.unique.rc.good.filter.unique.precluster.denovo.vsearch.pick.count_table, reference=trainset14_032015.rdp/trainset14_032015.rdp.fasta, taxonomy=trainset14_032015.rdp/trainset14_032015.rdp.tax, cutoff=80)
remove.lineage(fasta=merged.unique.rc.good.filter.unique.precluster.pick.fasta, count=merged.unique.rc.good.filter.unique.precluster.denovo.vsearch.pick.count_table, taxonomy=merged.unique.rc.good.filter.unique.precluster.pick.rdp.wang.taxonomy, taxon=Chloroplast-Mitochondria-unknown-Archaea-Eukaryota)

cluster.split(fasta=merged.unique.rc.good.filter.unique.precluster.pick.fasta, count=merged.unique.rc.good.filter.unique.precluster.denovo.vsearch.pick.count_table, taxonomy=merged.unique.rc.good.filter.unique.precluster.pick.rdp.wang.taxonomy, splitmethod=classify, taxlevel=4, cutoff=0.03)

make.shared(list=merged.unique.rc.good.filter.unique.precluster.pick.opti_mcc.unique_list.list, count=merged.unique.rc.good.filter.unique.precluster.denovo.vsearch.pick.count_table, label=0.03)
classify.otu(list=merged.unique.rc.good.filter.unique.precluster.pick.opti_mcc.unique_list.list, count=merged.unique.rc.good.filter.unique.precluster.denovo.vsearch.pick.count_table, taxonomy=merged.unique.rc.good.filter.unique.precluster.pick.rdp.wang.taxonomy, label=0.03)
